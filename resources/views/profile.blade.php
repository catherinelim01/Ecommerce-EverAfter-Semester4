                    ...
                    <form method="POST" class="formInsert" action="/profile">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <input type="text" class="form-control" required placeholder="First name *"
                                    name="first_name" value="<?php echo $data[0]['first_name']; ?>">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Last name " name="last_name"
                                    value="<?php echo isset($data[0]['last_name']) ? $data[0]['last_name'] : ''; ?>">

                            </div>
                        </div>
                        <div class="form-group mt-20">
                            <input type="email" class="form-control" id="exampleInputEmail1" name="customer_email"
                                required placeholder="Email address *" value="<?php echo $data[0]['customer_email']; ?>"
                        ...
                        <div class="form-group mt-20">
                            ...
                            <input type="password" class="form-control" name="password" placeholder="Current password"
                                id="currpass">
                            <input type="password" class="form-control mt-10" name="new_password"
                                placeholder="New password" id="newpass">
                            <input type="password" class="form-control mt-10" name="confirm_password"
                        ...
                        <div class="row">
                            <div class="col-6 pl-0">
                                <button type="submit" name="action" value="updateProfile"
                                    class="btn btn-primary mt-10 pb-20 login">SAVE CHANGES</button>
                            </div>
                            <div class="col-6 pr-0" style="text-align:end;">
                                <button type="submit" name="action" value="logout"
                                    class="btn btn-primary mt-10 pb-20 login">LOG OUT</button>
                            </div>
                        </div>
                    </form>
                    <?php } ?>
            ...
            for($i = 0; $i < count($data); $i++) { ?>
                ...
                <div class="row mb-50">
                    ...
                    <div class="col-3 col-sm-4 col-lg-5 judulcard pl-0">
                        ...
                        <button id="open-popup" type="submit" class="btn btn-primary detailkiri details"
                            onclick="document.querySelector('.popup').style.display = 'block'">Details</button>
                    </div>
