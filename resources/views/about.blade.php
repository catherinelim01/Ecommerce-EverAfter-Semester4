        ...
        <div class="about-area">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 abt">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>Our Story</h2>
                            <p class="pera">Welcome to Ever After Essentials! <br>
                                 We believe that every girl should feel confident and stylish in her own unique way. Our clothing line is dedicated to providing trendy and fashionable options that not only look great but also make girls feel amazing.</p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="about-img pb-bottom">
                            <img src="{{ asset('assets/images/about/about1.jpg') }}" alt="" class="w-100">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 abt">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>Thoughtfully-Made Designs</h2>
                            <p class="pera">
                                We are inspired by the unique styles and personalities of the girls who wear our clothing. Our designs are meant to be mixed and matched to create a look that is uniquely yours. Whether you're looking for a cute dress for a special occasion or a comfortable outfit for a day of play, we always have something for you!

                                That's why we use high-quality materials and partner with manufacturers who share our values. Our clothing is made to last, so you can feel good about your purchase knowing that it was made with care and consideration for the environment.
                               </p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="about-img pb-bottom">
                            <img src="{{ asset('assets/images/about/about2.jpg') }}" alt="" class="w-100">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-10 abt">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>Perfecting The Asian Fit</h2>
                            <p class="pera">
                                We are dedicated to serving the Asian female market by offering accessible and carefully crafted designs that enhance confidence and beauty. We strongly believe that feeling good about oneself translates to looking great, and this empowers one to feel more self-assured. Our ultimate goal is to accompany you on life's journey, through all the stages and milestones, as a brand you can trust and rely on.</p>
                            <br> <br>
                        </div>
                    </div>
                </div>
              ...
              <div class="single-footer-caption mb-50">
                <div class="single-footer-caption mb-30">
                  ...
                  <div class="footer-logo mb-35">
                    <a href="index.html"
                      ><img src="{{ asset('assets/images/logo/logo_putih.png') }}" alt=""
                    /></a>
                  </div>
